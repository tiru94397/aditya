          ...
          <CardContent>
            <Tabs defaultValue="login" className="w-full">
              ...
              <TabsContent value="login" className="space-y-4 mt-6">
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <Button 
                    type="submit" 
                    className="w-full bg-accent hover:bg-accent/90 text-accent-foreground border-0 h-12 rounded-lg shadow-lg hover:shadow-xl transition-all duration-200"
                  >
                    Sign In
                  </Button>
                </form>
            ...
            <div className="mt-6">
              ...
              <Button 
                onClick={onLogin}
                variant="outline" 
                className="w-full mt-4 h-12 rounded-lg border-border hover:bg-accent/10 transition-colors duration-200"
              >
